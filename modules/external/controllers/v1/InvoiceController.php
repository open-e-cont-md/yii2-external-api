...
use openecontmd\internal_api\models\ExternalInvoiceAPI;
 ...
 *              @OA\Examples(example="result_invoice", value={
 ...
 "controller": "invoice",
 "entry_point": "https://api.open.e-cont.md/external/v1/invoice/{action}"
 }
...
/** Set Invoice Number
 * @OA\Post(
 *     path="/external/v1/invoice/set-invoice-number",
 *     tags={"external"},
 *     @OA\Response(
 *         response="200",
...
/** Set Issue Date
 * @OA\Post(
 *     path="/external/v1/invoice/set-issue-date",
 *     tags={"external"},
 *     @OA\Response(
 *         response="200",
...
/** Set Due Date
 * @OA\Post(
 *     path="/external/v1/invoice/set-due-date",
 *     tags={"external"},
 *     @OA\Response(
 *         response="200",
...
/** Set Contact Name
 * @OA\Post(
 *     path="/external/v1/invoice/set-contact-name",
 *     tags={"external"},
 *     @OA\Response(
 *         response="200",
...
/** Set Contact E-Mail
 * @OA\Post(
 *     path="/external/v1/invoice/set-contact-email",
 *     tags={"external"},
 *     @OA\Response(
 *         response="200",
...
/** Set Identifier
 * @OA\Post(
 *     path="/external/v1/invoice/set-identifier",
 *     tags={"external"},
 *     @OA\Response(
 *         response="200",
...
/** Create Invoice
 * @OA\Post(
 *     path="/external/v1/invoice/create-invoice",
 *     method="post",
 *     tags={"external"},
 *     @OA\Response(
 *         response="200",
 ...
 */
	public function actionCreateInvoice()
	{
	    ...
	    $r1 = ExternalInvoiceAPI::checkInvoiceByNumber($id);
	    if ($r1) {
	        throw new HttpException(401, 'Повторный номер инвойса');
	    }
	    else {
	        $uid = ExternalInvoiceAPI::createUid();
	        $r2 = ExternalInvoiceAPI::createInvoice($uid, $id, $ubl_document);
	    }
 ...
 * @OA\Post(
 *     path="/external/v1/invoice/create-invoice-by-object",
 *     tags={"external"},
 ...
 * @OA\Post(
 *     path="/external/v1/invoice/create-party-by-object",
 *     tags={"external"},
...
/** Get Party By Id
 * @OA\Post(
 *     path="/external/v1/invoice/get-party-by-id",
 *     method="post",
 *     tags={"external"},
 *     @OA\Response(
 *         response="200",
 ...
 * @OA\Post(
 *     path="/external/v1/invoice/get-invoice-by-number",
 *     method="post",
 *     tags={"external"},
 *     @OA\Response(
 *         response="200",
 ...
 */
	...
	{
	    $id = Yii::$app->request->get('id');
	    $r1 = ExternalInvoiceAPI::getInvoiceByNumber($id);
