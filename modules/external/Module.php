...
namespace openecontmd\external_api\modules\external;

use Yii;
use yii\filters\VerbFilter;
use yii\web\BadRequestHttpException;
use openecontmd\internal_api\models\validation\ApiRequest;
use yii\web\HttpException;

class Module extends \yii\base\Module
{
	public $controllerNamespace = 'openecontmd\external_api\modules\external\controllers';
	public $gate = null;
...
//		$this->gate = Yii::$app->session->get('gate');
		...
		//$this->_check_token();
//		$method = str_replace('external/v1/', '', $this->module->requestedRoute);
